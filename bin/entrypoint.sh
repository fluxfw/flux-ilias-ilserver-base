...
ILIAS_ILSERVER_INDEX_PATH="${ILIAS_ILSERVER_INDEX_PATH:=$ILIAS_FILESYSTEM_DATA_DIR/ilserver}"
...
ILIAS_ILSERVER_PROPERTIES_PATH="${ILIAS_ILSERVER_PROPERTIES_PATH:=$ILIAS_FILESYSTEM_DATA_DIR/ilserver.properties}"
